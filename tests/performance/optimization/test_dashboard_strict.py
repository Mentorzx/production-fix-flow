...
@pytest.mark.xfail(reason="Current dashboard prototype uses Tailwind Play CDN (Technical Debt)")
...
@pytest.mark.xfail(reason="Current dashboard prototype uses Babel Standalone (Technical Debt)")
