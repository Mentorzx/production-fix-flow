...
class TestEnsembleWrappersContract:
    ...
    def test_transe_wrapper_signature(self):
        """Verifica assinatura do construtor RotatEWrapper."""
        from pff.validators.ensembles.ensemble_wrappers import RotatEWrapper
        import inspect

        sig = inspect.signature(RotatEWrapper.__init__)
