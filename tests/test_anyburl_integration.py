...
class TestAnyBURLLearner:
    ...
    @pytest.mark.asyncio
    async def test_learn_rules_with_homogenized_data(self, mock_config, sample_triples_df, temp_paths):
    ...
    @pytest.mark.asyncio
    async def test_learn_rules_without_homogenized_data(self, mock_config, sample_triples_df, temp_paths):
        sample_triples_df.write_parquet(temp_paths["parquet"])
    ...
    @pytest.mark.asyncio
    async def test_learn_rules_cleans_up_temp_files(self, mock_config, sample_triples_df, temp_paths):
        sample_triples_df.write_parquet(temp_paths["parquet"])
