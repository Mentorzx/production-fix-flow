...
class TestDurableRayTrainer:
    ...
    def test_get_durable_trainer(self):
        ...
        from pff.utils.acceleration.concurrency import get_durable_trainer
...
class TestAOTAutogradOptimizer:
    ...
    def test_aot_optimizer_initialization(self):
        ...
        from pff.utils.performance.performance import AOTAutogradOptimizer
    ...
    def test_optimize_transe_training_step(self):
        ...
        try:
            ...
            pytest.skip("Training step optimization failed (expected in test environment)")
