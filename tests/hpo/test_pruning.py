...
class TestPruning(unittest.TestCase):
    ...
    def test_trial_pruning(
        ...
        manager._train_epoch = MagicMock(return_value=0.1)
        ...
        # Run training
        stats = manager.train(self.train_triples, self.valid_triples, trial=mock_trial)

        # Assertions
        # Epochs 0, 1 were processed, epoch 2 started and then pruned
        self.assertEqual(stats["epochs_trained"], 3)
