...
import numpy as np
import pytest
from pff.utils.acceleration.symbolic_rule_accelerator import SymbolicRuleAccelerator
...
def sample_rules():
    ...
    return [
        ...
        },
        {
            ...
            'body': [
                {'subject': '?x', 'predicate': 'hasRevenue', 'object': '?y'}
            ],
            'confidence': 0.8
        },
        {
            ...
            'body': [
                {'subject': '?e', 'predicate': 'hasScore', 'object': '?s'}
            ],
            'confidence': 0.7
        }
    ]
