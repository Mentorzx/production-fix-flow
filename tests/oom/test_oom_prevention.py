...
def test_pc_chunk_sizes_are_reasonable():
    ...
    cuda_total_elements = batch_size * cuda_chunk * num_entities
    ...
    cpu_total_elements = batch_size * cpu_chunk * num_entities
...
def test_chunked_vs_unchunked_memory_usage():
    ...
    large_unchunked_size_mb = large_unchunked.element_size() / (1024**2)
    assert large_unchunked_size_mb > 100, "Unchunked tensor should be large"

    chunk_size_tails = 2000
    chunk_size_heads = 64
