...
def test_pc_strategy_matches_noisy_or_small_input():
    ...
    pc = ProbabilisticCircuitStrategy(fallback_to_noisy_or=True, max_rules_per_circuit=1000)
...
def test_pc_strategy_fallback_on_rule_limit():
    ...
    pc = ProbabilisticCircuitStrategy(fallback_to_noisy_or=True, max_rules_per_circuit=2)
...
def test_pc_strategy_no_fallback_raises():
    ...
    pc = ProbabilisticCircuitStrategy(fallback_to_noisy_or=False, max_rules_per_circuit=1)
