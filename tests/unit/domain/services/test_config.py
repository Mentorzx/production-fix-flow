...
class TestSettings:
    ...
    def test_celery_broker_url(self, monkeypatch):
        """Test Celery broker URL generation from REDIS_HOST/PORT."""
        # Remove any env vars that might override our test values
