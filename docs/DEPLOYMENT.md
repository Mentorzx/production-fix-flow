...
2. [Quick Start (Docker-first)](#quick-start-docker-first)
...
# Optional: validate the Docker-first wrappers
...
# The system uses direct ingestion through pff/infrastructure/persistence/db/ingestion.py
