...
Hipótese expansível testada: foi adicionado o cenário `edge_capacity_expandable`, em que o espaço inicial mantém `embedding_dim<=512`, mas o domínio permitido vai até 1024 e o ótimo sintético fica acima do teto inicial. A política `advisor_domain_edge_gp` força expansão de domínio apenas quando a elite encosta na borda superior de `embedding_dim` e a validação Wilson-LB do Advisor passa de 0.45. Em 20 seeds, 30 trials e Advisor isolado, o resultado foi positivo e sem perdas contra GP-BO (média 0.656422 vs 0.646381; delta +0.010041; IC95 [0.000000, 0.030122]; 1 vitória, 19 empates, 0 derrotas), mas ainda não significativo (Wilcoxon/Holm p=0.158655). Isso é o melhor recorte mecanisticamente alinhado ao propósito do Advisor até aqui, mas ainda não sustenta SOTA.
