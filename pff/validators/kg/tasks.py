...
# def _miner(cfg_path: str | Path = "config/models/kg.yaml") -> KGMiner:
#     """Helper que carrega configuração e devolve um *KGMiner*."""
#     return KGMiner.from_file(cfg_path)


# @app.task(name="kg.train_anyburl")
# def train_anyburl(cfg_path: str | Path = "config/models/kg.yaml") -> None:  # noqa: D401
#     _miner(cfg_path).train_anyburl()


# @app.task(name="kg.train_pyclause")
# def train_pyclause(cfg_path: str | Path = "config/models/kg.yaml") -> None:  # noqa: D401
#     _miner(cfg_path).train_pyclause()


# @app.task(name="kg.train_full")
# def train_full(cfg_path: str | Path = "config/models/kg.yaml") -> None:  # noqa: D401
