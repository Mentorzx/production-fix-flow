...
class TrialEvaluationPipeline:
    ...
    def run(self) -> float:
        ...
        Returns:
            float: Normalized composite score (MRR scaled to [0, 1]).
        """
        check_interruption()
    ...
    def _train_kge(self) -> None:
        ...
        raw_metrics["best_mrr"] = kge_stats.get("best_val_mrr", raw_metrics.get("mrr", 0.0))
        raw_metrics["best_mcc"] = kge_stats.get("best_val_mcc", raw_metrics.get("mcc", 0.0))
