...
import { TrialLearningMetricsCard, FoldConfusionsCard, FullMetricsLogCard, DetailedHistoryCard } from "../features/hpo/charts/AllCharts.js";
        ...
        return (
            <div className="grid grid-cols-12 gap-6 p-2">
                ...
                <div className="col-span-12 grid grid-cols-12 gap-6 min-h-0 lg:h-[480px] lg:grid-rows-1 animate-slide-up delay-100">
                    <div className="col-span-12 lg:col-span-8 h-full min-h-0"><IncumbentTrajectoryCard trials={filteredTrials} /></div>
                    <div className="col-span-12 lg:col-span-4 h-full min-h-0"><BestTrialCard trial={bestTrialNoWarmstart} delay={600} /></div>
                </div>
