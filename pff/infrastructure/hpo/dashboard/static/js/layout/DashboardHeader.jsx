...
const PeakStateLogo = ({ isRunning }) => {
    ...
    const glowColor = isRunning ? hexToRgba(Theme.palette.cyberYellow, 0.6) : hexToRgba(Theme.palette.cyan, 0.6);

    return (
        <div className={`relative w-10 h-10 flex items-center justify-center pulso-logo ${isRunning ? 'training' : ''}`}>
            {/* Outer glow ring */}
            <div
                    ...
                    <div className="flex items-center gap-2">
                        <h1
                            ...
                            style={{
                                ...
                                background: 'linear-gradient(90deg, var(--viz-text-primary) 0%, var(--viz-palette-4-yellow) 50%, var(--viz-text-primary) 100%)',
            ...
            <div className="flex items-center gap-6">
                ...
                <div className="flex items-center gap-4 border-l pl-6" style={{ borderColor: 'var(--viz-border)' }}>
                    ...
                    <div className="hidden lg:flex items-center gap-3 mr-4">
                        <label className="flex items-center gap-2 cursor-pointer group select-none" title="Incluir Warmup">
                            <input
                                type="checkbox"
                            ...
                            />
                            <span className="text-[10px] uppercase font-bold text-zinc-500 group-hover:text-zinc-300 transition-colors">Warmup</span>
                        </label>
                        <label className="flex items-center gap-2 cursor-pointer group select-none" title="Incluir Pruned">
                            <input
                                type="checkbox"
                                ...
                                className="w-3.5 h-3.5 rounded-sm border-zinc-600 bg-zinc-800 text-orange-500 focus:ring-0 focus:ring-offset-0"
                            />
                            <span className="text-[10px] uppercase font-bold text-zinc-500 group-hover:text-zinc-300 transition-colors">Pruned</span>
                        </label>
                    </div>
