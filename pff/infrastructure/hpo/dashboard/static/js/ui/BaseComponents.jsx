        ...
        return (
            <div className="w-72 border p-3 rounded-xl shadow-2xl text-[10px]" style={{ backgroundColor: Theme.ui.background, borderColor: Theme.ui.border, color: Theme.ui.text.secondary }}>
                <div className="space-y-2">
                    <div>
                        <span className="text-[8px] font-black uppercase block mb-1" style={{ color: Theme.semantic.warning }}>Explicação Técnica</span>
                        <div className="leading-tight" style={{ color: Theme.ui.text.primary }}>{helpText.tech}</div>
                    </div>
                    {helpText.simple && (
                        <div className="pt-2 border-t" style={{ borderColor: Theme.ui.border }}>
                            <span className="text-[8px] font-black uppercase block mb-1" style={{ color: Theme.semantic.success }}>Para Leigos</span>
                            <div className="italic leading-tight border-l-2 pl-2" style={{ color: Theme.palette.mint, borderColor: Theme.palette.vividGreen + '33' }}>{helpText.simple}</div>
                        </div>
                    )}
    ...
    const card = (
        ...
        >
            <div className="flex items-start justify-between gap-4">
                <span className="text-[10px] font-black uppercase tracking-[0.2em] opacity-40" style={{ color: activeColor }}>
                    {label}
                </span>
                <span className="text-[10px] font-mono font-bold tracking-tight tabular-nums" style={{ color: deltaColor }}>
            ...
            <div className="mt-2 flex flex-col flex-1 min-h-0">
                ...
                {subtext && (
                    <div className="mt-1 text-[10px] opacity-40 font-bold uppercase" style={{ color: activeColor }}>
                        {subtext}
                    </div>
                )}
            </div>
            ...
            <div className="mt-1 flex items-center justify-end min-h-[14px]">
                {directionText && (
                    <span className="text-[9px] font-black uppercase tracking-widest opacity-30" style={{ color: Theme.ui.text.secondary }}>
            ...
            {pct !== null && (
                <div className="mt-3 h-1.5 w-full rounded-full overflow-hidden" style={{ backgroundColor: Theme.ui.border }}>
                    <div
                        className="h-full"
                        style={{
                            width: `${pct}%`,
...
export const Card = React.memo(({ children, className = "", title, icon: Icon, action, helpText, glow, headerRight }) => (
    <article
