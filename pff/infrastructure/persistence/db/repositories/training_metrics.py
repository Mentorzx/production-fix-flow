...
class TrainingMetricsRepository:
    ...
    async def get_best_epoch(
        ...
        logger.info(
            f"Melhor época para {model_name}: {best_epoch} ({metric_name}={best_value:.4f})"
        )
    ...
    async def get_metric_history(
        self, model_name: str, metric_name: str, split: str | None = None
    ...
    async def get_summary_statistics(
        self, model_name: str | None = None, execution_log_id: int | None = None
    ) -> dict:
        """
