...
class CompositeValidationObserver(ValidationObserver):
    """
    Composite observer that dispatches events to multiple observers.

    Implements the Composite pattern for multi-observer support.
    ...
    Example:
        ...
        ...     MetricsValidationObserver(metrics_dir),
        ... ])
        >>> composite.on_event(event)  # Dispatches to all observers
    """
    ...
    def __init__(self, observers: list[ValidationObserver] | None = None):
        ...
        Args:
            observers: List of observers to dispatch to
        """
        self._observers: list[ValidationObserver] = observers or []
