...
def generate_model(
    ...
    Args:
        ...
        output_path (str | Path | None): Path where the generated model will be saved. Defaults to src/pff/domain/kg/model.py.
    """
    default_schema = settings.OUTPUTS_DIR / "ensemble" / "rules" / "schema.json"
    default_output = settings.PATTERNS_DIR.parent / "model.py"
