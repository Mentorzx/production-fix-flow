import { AlertTriangle, CheckCircle, X } from "./BaseComponents.jsx";
        ...
        {toasts.map((toast) => {
          ...
          return (
            <article
              ...
              style={{
                borderColor: `color-mix(in srgb, ${meta.accent}, var(--viz-border) 55%)`,
                background:
            ...
            >
              <div className="flex items-start gap-2.5 px-3 py-2.5">
                <span
                  ...
                  style={{
                    ...
                    color: meta.accent,
                    backgroundColor: `color-mix(in srgb, ${meta.accent}, transparent 88%)`,
                  }}
                >
                  <Icon size={14} />
                </span>
                ...
                <div className="min-w-0 flex-1">
                  <div className="mb-1 flex items-center gap-2">
                    <p className="truncate text-[11px] font-bold uppercase tracking-[0.12em] text-[var(--viz-text-primary)]">
                      {toast.title}
                    </p>
                    <span
              ...
              >
                <div
                  ...
                  style={{
                    width: `${remaining * 100}%`,
                    background: `linear-gradient(90deg, ${meta.accent} 0%, color-mix(in srgb, ${meta.accent}, white 18%) 100%)`,
                  }}
                />
              </div>
            </article>
