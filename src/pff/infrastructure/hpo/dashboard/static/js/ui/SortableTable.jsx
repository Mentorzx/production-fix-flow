    ...
    if (sort && sort.key) {
      ...
      sorted.sort((a, b) => {
        ...
        if (activeColumn?.sortValue) {
          aVal = activeColumn.sortValue(a);
          bVal = activeColumn.sortValue(b);
        } else {
          aVal = a[sort.key];
          bVal = b[sort.key];
        }
            ...
            {paginatedData.map((row) => (
              ...
              >
                {columns.map((col, j) => {
                  ...
                  const paddingClass = j === 0 ? "px-4" : isGroupStart ? "pl-6 pr-3" : "px-3";
                  const borderClass = isGroupStart ? "border-l border-zinc-800/60" : "";
                    ...
                    >
                      ...
                      >
                        {col.render
                          ...
                          : (row[col.key] ?? <span className="text-zinc-600">—</span>)}
                      </div>
                    </td>
                  );
                })}
