            ...
            <div className="flex items-center gap-4">
                ...
                >
                    <label className="flex items-center gap-2 cursor-pointer group select-none">
                        ...
                        />
                        <span className="text-[11px] group-hover:text-zinc-200 transition-colors" style={{ color: 'var(--viz-text-secondary)' }}>Warmup</span>
                    </label>
                    <label className="flex items-center gap-2 cursor-pointer group select-none">
                        <input
                            type="checkbox"
                            ...
                            className="w-3.5 h-3.5 rounded-sm border-zinc-600 bg-zinc-800 text-orange-500 focus:ring-1 focus:ring-orange-500/50"
                        />
                        <span className="text-[11px] group-hover:text-zinc-200 transition-colors" style={{ color: 'var(--viz-text-secondary)' }}>Pruned</span>
                    </label>
                    <label className="flex items-center gap-2 cursor-pointer group select-none">
                        <input
                            type="checkbox"
                        ...
                        />
                        <span className="text-[11px] group-hover:text-zinc-200 transition-colors" style={{ color: 'var(--viz-text-secondary)' }}>Completos</span>
                    </label>
                </div>
            </div>
