                    ...
                    >
                        ...
                        <ChartContainer minHeight={120} className="h-full">
                            <AreaChart data={chartData} margin={{ top: 20, right: 0, left: 0, bottom: 0 }}>
                                ...
                                <Area type="monotone" dataKey="cpu" stroke={Theme.semantic.hardware.cpu} fill={Theme.semantic.hardware.cpu} fillOpacity={0.08} strokeWidth={1.5} name="CPU" dot={false} activeDot={{ r: 3 }} />
                                <Area type="monotone" dataKey="gpu" stroke={Theme.semantic.hardware.gpu} fill={Theme.semantic.hardware.gpu} fillOpacity={0.08} strokeWidth={1.5} name="GPU" dot={false} activeDot={{ r: 3 }} />
                                <Area type="monotone" dataKey="vram" stroke={Theme.semantic.hardware.vram} fill={Theme.semantic.hardware.vram} fillOpacity={0.08} strokeWidth={1.5} name="VRAM" dot={false} activeDot={{ r: 3 }} />
                                <Area type="monotone" dataKey="ram" stroke={Theme.semantic.hardware.ram} fill={Theme.semantic.hardware.ram} fillOpacity={0.08} strokeWidth={1.5} name="RAM" dot={false} activeDot={{ r: 3 }} />
                            </AreaChart>
                        </ChartContainer>
                    </div>
                )}
