...
import { Card, Sliders, colors, DefaultCartesianGrid, ChartContainer, WithData } from "../../../ui/BaseComponents.jsx";
        ...
        return (
            <div className="w-72 p-4 bg-zinc-950 border border-zinc-800 rounded-xl shadow-2xl text-left font-sans z-50">
                <div className="space-y-3">
                    ...
                    <div className="pt-1">
                        <span className="text-[8px] font-black text-amber-500 uppercase block mb-1">Valor Bruto</span>
                        <p className="text-[11px] text-zinc-100 font-mono bg-zinc-900/50 p-1 rounded-sm border border-zinc-800">{Number(rawValue).toFixed(6)}</p>
                    </div>
                    {hint && (
                        <>
                            <div>
                            ...
                            {Array.isArray(hint.extra) && hint.extra.length > 0 && (
                                <div className="pt-2 border-t border-zinc-900">
                                    <span className="text-[8px] font-black text-amber-400 uppercase block mb-1">Detalhes</span>
