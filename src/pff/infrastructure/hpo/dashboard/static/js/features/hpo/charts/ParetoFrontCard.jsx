...
import { TargetIcon, colors, defaultChartMargins, DefaultCartesianGrid, DefaultTooltip, DefaultTooltipCursor } from "../../../ui/BaseComponents.jsx";
...
export const ParetoFrontCard = ({ trials }) => {
    ...
    return (
        <ChartCard title="Fronteira de Pareto" icon={TargetIcon} registryKey="pareto_front" hasData={data.length > 0}>
