...
export const KpiRow = () => {
    const {
        viewMode, data, trials, bestTrialNoWarmstart, objectiveDirection,
        bestSeries, bestDeltaPct, lastDurations, avgDuration, avgDurationDeltaPct,
        avgDurationParts, estimatedCompletion, etaDeltaPct, etaParts,
        latestTrialMetrics, liveMetricSeries, deltaFromSeries,
    } = useKpiMetrics();
