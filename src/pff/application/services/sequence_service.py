...
Notes:
    ...
    File: src/pff/application/services/sequence_service.py
...
class SequenceService:
    ...
    def __init__(self, services: dict[str, Any]) -> None:
        ...
        self._sequences = self._file_manager.read(config_path, return_native=True)
    ...
    async def _execute_steps(
        ...
        Args:
            ...
            context: Input value used by this callable.
    ...
    async def _evaluate_expression(
        ...
        Args:
            ...
            expression: Input value used by this callable.
        ...
        try:
            ...
            if "info" in context:
                ...
                logger.debug(f"Current contract status: {status}")
    ...
    async def _render(self, value: Any, context: dict[str, Any]) -> Any:
        ...
        async def repl(m: re.Match[str]) -> str:
            ...
            Args:
                ...
                m: Input value used by this callable.
